...
Gerenciador de tarefas gamificado focado em produtividade para estudantes. Transforma o ato de estudar em uma jornada heroica com XP, níveis, missões, loja de recompensas, timer Pomodoro, revisão espaçada e conexão social.
...
| Estilos | Vanilla CSS com variáveis `data-theme` (2 temas: Modo Claro / Modo Escuro) |
...
├── trilha.html             # Trilha da Evolução (80 níveis, battle pass)
├── src/
...
| Trilha | `trilha.html` | 80 níveis exponenciais + recompensas (battle pass) |
